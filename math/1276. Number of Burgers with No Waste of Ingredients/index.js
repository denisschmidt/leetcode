...
// Brute Force
// Time O(N) N - cheeseSlices
// Space O(1)
const numOfBurgers_II = (tomatoSlices, cheeseSlices) => {
  let burgers = cheeseSlices;

  for (let jumbo = 0; jumbo <= burgers; jumbo++) {
    let small = burgers - jumbo;
