...
Рекуррентные отношения:
                        холд            продажа
  T[i][k][0] = max(T[i-1][k][0], T[i-1][k][1] + prices[i]) - это как максимальная прибыль в конце дня
...
1) Для T[i][k][0] в рекуррентном отношении это действия, предпринятые к концу i-й дня, могут быть только холдом и продажей, 
...
2) Для T[i][k][1] в рекуррентных отношениях действия, предпринятые в i-й день, могут быть только холдом или покупкой, 
