...
// Делаем обход postorder и по мере получения пути записываем его в мапу
...
Тип рекурсии bottom-top

Для данного типа дерева будет слудующий порядок обхода left-right-root;
