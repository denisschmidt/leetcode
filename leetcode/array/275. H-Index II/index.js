...
Учитывая отсортированный список цитат размером n в порядке возрастания,
просят найти первое число citations[i], которое соответствует ограничению citations[i] >= n - i.
