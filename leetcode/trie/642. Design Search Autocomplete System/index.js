...
For each character they type except '#', you need to return the top 3 historical hot sentences t
hat have prefix the same as the part of sentence already typed. Here are the specific rules:
...
The constructor function: AutocompleteSystem(String[] sentences, int[] times): 
...
Example: Operation: AutocompleteSystem(["i love you", "island","ironman", "i love leetcode"], [5,3,2,2])
...
Explanation: T
  he user finished the input, the sentence "i a" should be saved as a historical sentence in system.
...
class AutocompleteSystem {
  ...
  input(c) {
    ...
    for (let [key, value] of current.counts) {
      list.push({ word: key, count: value });
    }
...
let auto = new AutocompleteSystem(['i love you', 'island', 'ironman', 'i love leetcode'], [5, 3, 2, 2]);

const res = auto.input('i');
console.log(res);
