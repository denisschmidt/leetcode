...
class TokenBucket(object):
    ...
    def allowRequest(self, tokens = 1):
        self.reFill() # First refill bucket with tokens accumulated since the last call
    ...
    def reFill(self):
        ...
        tokensToAdd = (now - self.lastRefillTimestamp) * self.refillRate / 1e9 # These many tokens accumulated since the last refill

        self.currentBucketSize = min(self.currentBucketSize + tokensToAdd, self.maxBucketSize)
