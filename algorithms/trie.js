...
Одним из важных свойств Trie является то, что все потомки узла имеют общий префикс строки, связанной с этим узлом.

Вот почему Три также называется префиксом дерева.

Trie широко используется в различных приложениях, таких как автозаполнение, проверка орфографии и т. Д.
...
Используя Trie, мы можем искать ключ за O(M) время, где M - максимальная длина строки.
